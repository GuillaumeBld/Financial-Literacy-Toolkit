...
const REPORT_MD = "/root/Financial-Literacy-Toolkit/_project/source_of_truth/pretest_report.md";
const OUTPUT_PATH = `${EXPORTS_DIR}/QUIN102_Pretest_Results_Report.docx`;
...
const mdContent = fs.readFileSync(REPORT_MD, "utf-8");
