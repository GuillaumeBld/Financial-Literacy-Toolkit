...
3. **CSV Files**: Ensure `source_of_truth/baseline+40_Questions.csv` is in place (13 baseline + 40 anchor items)
...
- Read all questions from `source_of_truth/baseline+40_Questions.csv`
- Import 13 baseline covariates (B1-B13) and 40 anchor items (Q1-Q40)
- Set `is_active=true` for all 40 anchor items
- Mark 26 knowledge items (Q1-Q14, Q29-Q40) as scored
- Mark 14 preference items (Q15-Q28) as unscored covariates
...
2. Verify all 40 anchor items are active
3. Verify 26 knowledge items are marked as scored (Q1-Q14, Q29-Q40)
4. Verify 14 preference items are marked as unscored (Q15-Q28)
5. Verify 13 baseline covariates are properly configured (B1-B13)
